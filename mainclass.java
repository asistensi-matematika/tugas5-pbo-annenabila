...
public class mainclass {
    ...
    public static void main(String[] args) {
        ...
        perpus[0] = new buku("winter in tokyo", "ilana tan", "fiksi", 600);
        fiksi += 1;
        halamanfiksi += 600;
        jumlahhala += 600;
        n += 1;

        perpus[1] = new buku("some historical thing", "hippocrates", "nonfiksi", 600);
        nonfiksi += 1;
        halamannonfiksi += 600;
        jumlahhala += 600;
        n += 1;
        perpus[2] = new buku("cape cape cape", "anne", "nonfiksi", 600);
        nonfiksi += 1;
        halamannonfiksi += 600;
        jumlahhala += 600;
        n += 1;
